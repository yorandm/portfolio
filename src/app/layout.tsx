      ...
      <div className="headerNav">
        <div className="header">
          ...
          <div className="headerInfo">
            ...
            <p>{"Hi I'm Yoran. I am a Belgian software engineer student at HoGent, currently in my final year. Apart from that I am volountier at FabLab Erpe-Mere where I have the responsibility for the Youth part of the organisation. Another passion I have is WSC Dr. Tistaertvrienden VZW, we create cycling races in and around Affligem, my home town. There I'm responsible for the applications at the municipalities, Belgian Cycling,... As well as the orginazation of two races, 'Abdijkoers voor dames' and 'Affligem Classic'. And last but not least, I love themeparks. I love them so much that I even have a job in one as student. In Plopsaland De Panne I'm in the operations department. "}</p>
          </div>
        </div>
        <nav className="nav">
          <ul>
